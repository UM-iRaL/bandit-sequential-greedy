function H = rb_jacobian_x(xx,xy,yx,yy,flag)
% H = rb_jacobian(xx,xy,yx,yy,flag)
%
...
%
% OUTPUT:
%   H = 2 x 3 x num_y x num_x = if flag == true
%     = 2 x 3 x max(num_x,num_y)         = if flag == false
%
...
if(flag)
    ...
    if( num_x == 1 && num_y == 1)
        H = [-[r1, r2]/r 0; [r2 -r1]/r_up_2 -1];
    else
        H = zeros(2,3,max(num_y,num_x));
        H(1,1,:) = -r1./r;
        H(1,2,:) = -r2./r;
        H(1,3,:) = 0;
        H(2,1,:) = r2./r_up_2;
