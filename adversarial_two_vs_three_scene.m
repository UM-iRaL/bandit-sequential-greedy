...
%             h0.tg(kk) = draw_pose_nx([], tg_true(:,kk,1,rep),'g',5);
            ...
            if strcmp(planner_name, 'bsg')
                title('BSG: 2 Robots vs. 3 Adversarial Targets [2X]', 'FontSize', 15);
            else
                title('SG-Heuristic: 2 Robots vs. 3 Adversarial Targets [2X]', 'FontSize', 15);
            end
